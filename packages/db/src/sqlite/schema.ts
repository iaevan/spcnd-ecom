...
import { bool, id, json, money, num2, stock, ts } from './columns.js';
...
export const sessions = sqliteTable(
  'sessions',
  {
    ...
    sessionExpiry: integer('session_expiry').notNull(),
  },
  (t) => [
...
export const shippingClasses = sqliteTable(
  'shipping_classes',
  {
    id: id(),
...
export const productVariationAttributes = sqliteTable(
...
export const attributeTaxonomies = sqliteTable('attribute_taxonomies', {
...
export const productAttributeTerms = sqliteTable(
...
export const productCategories = sqliteTable(
  'product_categories',
  {
    ...
    slug: text('slug').notNull(),
    description: text('description').notNull().default(''),
    parentId: integer('parent_id').references((): AnySQLiteColumn => productCategories.id, {
      onDelete: 'cascade',
    }),
...
export const productDownloads = sqliteTable(
  'product_downloads',
  {
    id: id(),
    productId: integer('product_id')
...
export const productMeta = sqliteTable(
  'product_meta',
  {
    id: id(),
    productId: integer('product_id')
...
export const productCategoryMap = sqliteTable(
...
export const productTagMap = sqliteTable(
  'product_tag_map',
  {
    productId: integer('product_id')
      .notNull()
...
export const productUpsellMap = sqliteTable(
  'product_upsell_map',
  {
    productId: integer('product_id')
      .notNull()
      .references(() => products.id, { onDelete: 'cascade' }),
    upsellId: integer('upsell_id')
      .notNull()
      .references(() => products.id, { onDelete: 'cascade' }),
  },
...
export const productCrosssellMap = sqliteTable(
  'product_crosssell_map',
  {
    productId: integer('product_id')
      .notNull()
      .references(() => products.id, { onDelete: 'cascade' }),
    crosssellId: integer('crosssell_id')
      .notNull()
      .references(() => products.id, { onDelete: 'cascade' }),
  },
...
export const productGroupedMap = sqliteTable(
  'product_grouped_map',
  {
...
export const productMetaLookup = sqliteTable(
  'product_meta_lookup',
  {
    productId: integer('product_id')
      .primaryKey()
...
export const productAttributesLookup = sqliteTable(
...
export const orders = sqliteTable(
  'orders',
  {
    ...
    parentId: integer('parent_id').references((): AnySQLiteColumn => orders.id, {
      onDelete: 'cascade',
    }),
...
export const orderItemMeta = sqliteTable(
  'order_item_meta',
  {
    id: id(),
...
export const orderRefunds = sqliteTable(
  'order_refunds',
  {
    ...
    reason: text('reason'),
    refundedBy: integer('refunded_by').references(() => customers.id, { onDelete: 'set null' }),
...
export const orderMeta = sqliteTable(
  'order_meta',
  {
    id: id(),
    orderId: integer('order_id')
...
export const customerMeta = sqliteTable(
  'customer_meta',
  {
    id: id(),
    customerId: integer('customer_id')
...
export const taxClasses = sqliteTable(
  'tax_classes',
  {
    id: id(),
    name: text('name').notNull(),
...
export const taxRates = sqliteTable(
  ...
  {
    id: id(),
    taxClassId: integer('tax_class_id').references(() => taxClasses.id, { onDelete: 'cascade' }),
    country: text('country').notNull().default(''),
    state: text('state').notNull().default(''),
...
export const taxRateLocations = sqliteTable(
  'tax_rate_locations',
  {
    id: id(),
...
export const paymentTokens = sqliteTable(
  'payment_tokens',
  {
    id: id(),
    userId: integer('user_id').references(() => customers.id, { onDelete: 'cascade' }),
...
export const paymentTokenMeta = sqliteTable(
  'payment_token_meta',
  {
    id: id(),
...
export const downloadPermissions = sqliteTable(
  'download_permissions',
  {
    ...
    orderId: integer('order_id')
      ...
      .references(() => orders.id, { onDelete: 'cascade' }),
    orderKey: text('order_key').notNull(),
    userId: integer('user_id').references(() => customers.id, { onDelete: 'set null' }),
...
// ---------------------------------------------------------------------------
// Settings (typed tables + escape hatch)
// ---------------------------------------------------------------------------

export const settingsBoolean = sqliteTable('settings_boolean', {
  key: text('key').primaryKey(),
  value: bool('value').notNull(),
});

export const settingsInteger = sqliteTable('settings_integer', {
  key: text('key').primaryKey(),
  value: integer('value').notNull(),
});

export const settingsString = sqliteTable('settings_string', {
  key: text('key').primaryKey(),
  value: text('value').notNull(),
});

export const settingsJson = sqliteTable('settings_json', {
  key: text('key').primaryKey(),
...
export const orderStats = sqliteTable(
  'order_stats',
  {
    orderId: integer('order_id')
      .primaryKey()
...
export const orderProductLookup = sqliteTable(
...
export const orderTaxLookup = sqliteTable(
  'order_tax_lookup',
  {
    orderId: integer('order_id')
      .notNull()
      .references(() => orders.id, { onDelete: 'cascade' }),
    taxRateId: integer('tax_rate_id').notNull(),
    dateCreated: ts('date_created').notNull(),
    shippingTax: money('shipping_tax').notNull().default('0.0000'),
...
export const orderCouponLookup = sqliteTable(
  'order_coupon_lookup',
  {
    orderId: integer('order_id')
      .notNull()
...
export const customerLookup = sqliteTable(
  'customer_lookup',
  {
    customerId: integer('customer_id')
      .primaryKey()
...
export const categoryLookup = sqliteTable('category_lookup', {
  categoryId: integer('category_id')
    .primaryKey()
    .references(() => productCategories.id, { onDelete: 'cascade' }),
